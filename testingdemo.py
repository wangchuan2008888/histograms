...
batchsize = [100000]
userbucketsize = 1
attributes = ['bimodal', 'uniform', 'norm']#['bimodal', 'uniform', 'norm', ['chi', 'logistic', 'beta', 'gamma']
...
for attr in attributes:
    for numbuckets in buckets:
        for batch in batchsize:
            ...
            # control = dynamic_histograms.control_histogram.Control_Histogram('dynamic_histograms/data/distributions.csv', numbuckets, outputpath)
            ...
            start_time = time.time()
            dc = dynamic_histograms.dc_histogram.DC_Histogram('dynamic_histograms/data/distributions.csv', numbuckets, outputpath)
            ...
            # start_time = time.time()
            # depth = dynamic_histograms.equidepth_histogram.Equidepth_Histogram('dynamic_histograms/data/distributions.csv', numbuckets,
            #                                                                     outputpath)
            ...
            # start_time = time.time()
            # maxdiff = dynamic_histograms.maxdiff_histogram.MaxDiff_Histogram('dynamic_histograms/data/distributions.csv', numbuckets,
            #                                                                   outputpath)
            ...
            # start_time = time.time()
            # sf = dynamic_histograms.sf_histogram.SF_Histogram('dynamic_histograms/data/distributions.csv', numbuckets, outputpath)
            ...
            # start_time = time.time()
            # spline = dynamic_histograms.spline_histogram.Spline_Histogram('dynamic_histograms/data/distributions.csv', numbuckets,
            #                                                               outputpath)
            ...
            # start_time = time.time()
            # dvo = dynamic_histograms.dvo_histogram.DVO_Histogram('dynamic_histograms/data/distributions.csv', numbuckets, outputpath)
