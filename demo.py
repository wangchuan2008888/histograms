...
control.create_histogram(attr, batchsize=100000, userbucketsize=25)
...
dc.create_histogram(attr, gamma=0.5, gammam=0.5, batchsize=100000, userbucketsize=25)
...
depth.create_histogram(attr, l=0, batchsize=100000, userbucketsize=25)
...
maxdiff.create_histogram(attr, batchsize=100000, userbucketsize=25)
...
sf.create_histogram(attr, alpha=0.5, m=0.0025, s=0.1, batchsize=100000, userbucketsize=25)
...
spline.create_histogram(attr, batchsize=100000, userbucketsize=25)
