...
control = dynamic_histograms.control_histogram.Control_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
...
# start_time = time.time()
# dc = dynamic_histograms.dc_histogram.DC_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
...
start_time = time.time()
depth = dynamic_histograms.equidepth_histogram.Equidepth_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
...
start_time = time.time()
maxdiff = dynamic_histograms.maxdiff_histogram.MaxDiff_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
...
start_time = time.time()
sf = dynamic_histograms.sf_histogram.SF_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
...
start_time = time.time()
spline = dynamic_histograms.spline_histogram.Spline_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
...
start_time = time.time()
dvo = dynamic_histograms.dvo_histogram.DVO_Histogram('dynamic_histograms/data/biaseddistributions.csv', buckets, outputpath)
