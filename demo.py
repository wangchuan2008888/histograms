...
dc.create_histogram('norm', gamma=0.5, gammam=0.5, batchsize=100000, userbucketsize=25)
...
depth.create_histogram('norm', l=0, batchsize=100000, userbucketsize=25)
...
maxdiff.create_histogram('norm', batchsize=100000, userbucketsize=25)
...
sf.create_histogram('norm', alpha=0.5, m=0.0025, s=0.1, batchsize=100000, userbucketsize=25)
...
spline.create_histogram('norm', batchsize=100000, userbucketsize=25)
...
dvo.create_dvo_histogram('norm', batchsize=100000, userbucketsize=25)
